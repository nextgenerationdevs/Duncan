	...
	private void initializeLanguageDialog()
	{
		...
		{					
			...
			public void actionPerformed(ActionEvent e)
			{
				...
				{
					JOptionPane.showMessageDialog(null, "Ёто default €зык: не удалить и не добавить!", "¬от так вот...", JOptionPane.ERROR_MESSAGE);
					languageBox.setSelectedIndex(0);
					return;
				}
				else if (language.equals("русский") || language.equals("украинский"))
				{
					for (InterfaceBundle bundle : LanguageFactory.bundles)
					{
						...
						{
							JOptionPane.showMessageDialog(null, "—ор€н такой €зык уже добавлен!", "¬от так вот...", JOptionPane.ERROR_MESSAGE);
							languageBox.setSelectedIndex(0);
							return;
						}
					}			
				...
				else
				{
					...
					JOptionPane.showMessageDialog(null, "—ор€н такого €зыка в бандлах нет!", "¬от так вот...", JOptionPane.ERROR_MESSAGE); 
					return;
				}
			}
		});
		...
		{			
			...
			public void actionPerformed(ActionEvent e)
			{
				...
				{
					JOptionPane.showMessageDialog(null, "—ор€н такой €зык удалить невозможно!", "¬от так вот...", JOptionPane.ERROR_MESSAGE); 
					return;
				}
			}	
		});
